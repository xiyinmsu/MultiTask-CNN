...
template <typename Dtype>
void caffe_axpy(const int N, const Dtype alpha, const Dtype* X, const int incX, 
...
template <typename Dtype>
void caffe_cpu_axpby(const int N, const Dtype alpha, const Dtype* X, const int incX, 
...
template <typename Dtype>
void caffe_gpu_axpy(const int N, const Dtype alpha, const Dtype* X, 
    int const incX, Dtype* Y, int const incY);
...
template <typename Dtype>
void caffe_gpu_axpby(const int N, const Dtype alpha, const Dtype* X,
    int const incX, const Dtype beta, Dtype* Y, int const incY);

/*template <typename Dtype>
void caffe_gpu_axpby(const int N, const Dtype alpha, const Dtype* X, const int incX, 
    const Dtype beta, Dtype* Y, const int incY);*/
