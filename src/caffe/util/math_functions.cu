...
template <>
void caffe_gpu_axpy<float>(const int N, const float alpha, const float* X,
    int const incX, float* Y, int const incY) {
...
template <>
void caffe_gpu_axpy<double>(const int N, const double alpha, const double* X,
    int const incX, double* Y, int const incY) {
...
template <>
void caffe_gpu_axpby<float>(const int N, const float alpha, const float* X,
    int const incX, const float beta, float* Y, int const incY) {
  caffe_gpu_scal<float>(N, beta, Y);
  caffe_gpu_axpy<float>(N, alpha, X, incX, Y, incY);
}

template <>
void caffe_gpu_axpby<double>(const int N, const double alpha, const double* X,
    int const incX, const double beta, double* Y, int const incY) {
  caffe_gpu_scal<double>(N, beta, Y);
  caffe_gpu_axpy<double>(N, alpha, X, incX, Y, incY);
}
